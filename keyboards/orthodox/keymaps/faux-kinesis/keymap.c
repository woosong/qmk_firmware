...
#define RC__SPC MT(MOD_RCTL, KC_SPC)
...
[_QWERTY] = KEYMAP( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    LG_BSPC, KC_ESC,  LOWER,            RAISE,   KC_ENT,  RC__SPC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT \
),
...
[_LOWER] = KEYMAP( \
  ...
  KC_LSFT, KC_DEL,  KC_END,  KC_PGDN, _______, _______, _______, _______, _______,          _______, _______, KC_RCTL, _______, _______, _______, KC_LCBR,  KC_RCBR, KC_RSFT \
),
...
[_RAISE] = KEYMAP( \
  ...
  KC_LSFT, KC_F11,  KC_F12,  _______, _______, _______, KC_LGUI, _______, _______,          _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_RSFT \
),
